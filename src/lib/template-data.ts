...
export const TEMPLATES: Template[] = [
  ...
  },
  {
    ...
    category: "Business Cards",
    price: "C$7.99",
    description: "An editorial identity for the luxury photographer — cool greys, sharp typography, and the quiet confidence of a curated portfolio.",
    tags: ["Business", "Photography", "Editorial"],
    colors: { bg: "from-[#E8E4E0] to-[#D8D4CE]", accent: "#2A2828", text: "#1A1818" },
    style: "business",
    includes: ["Front & back design", "QR code integration", "NFC tap support", "Downloadable PDF", "Public profile page", "Portfolio link"],
    features: ["Editorial aesthetic", "Photography branding", "Mobile-friendly", "Analytics dashboard", "Share via QR & NFC"],
  },
  {
  ...
  },
  {
    ...
    tags: ["Analytics", "Pro"],
    colors: { bg: "from-[#FFFFFF] to-[#F5F2ED]", accent: "#B8860B", text: "#1A1A1A" },
    style: "dashboard",
